...
def _model_fields(mode: str) -> List[Field]:
    ...
    fs += [
        ...
        Field("model.use_se", depends_on=unet + [_in("model.attention_type", ["none"])]),
        Field("model.se_reduction", depends_on=unet + [_in("model.attention_type", ["none"]), _truthy("model.use_se")]),
