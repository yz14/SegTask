...
ENUMS: Dict[str, List[str]] = {
    ...
    "model.attention_type":        ["none", "se", "eca", "cbam", "coord", "lka", "msca"],
...
def _train_fields() -> List[Field]:
    ...
    return [
        ...
        Field("train.swa_enabled"),
        Field("train.swa_start_ratio", depends_on=[_truthy("train.swa_enabled")]),
        Field("train.swa_bn_update_steps", depends_on=[_truthy("train.swa_enabled")]),
